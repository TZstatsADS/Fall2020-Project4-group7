...
The following table shows estimated ATEs, since we know the tree ATE for high dimensional dataset is -3 and for low dimensional dataset is 2.5. We could see that $Logistic FullMatching$ performs best, especially on the the balanced dataset.
```{r,echo = FALSE, results = TRUE, message=FALSE, warning = FALSE}
#ATE results
